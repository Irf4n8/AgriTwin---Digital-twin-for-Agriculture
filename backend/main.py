...
# Init Disease Detector
disease_detector = HybridDiseaseDetector()
...
# ===============================
MAGMARKNET_API_KEY = "579b464db66ec23bdd000001cdd3946e44ce4aad7209ff7b23ac571b"
AGMARKNET_URL = (
...
async def detect_disease(file: UploadFile = File(...)):
    try:
        ...
        # Create Base64 for external API
        image_base64 = base64.b64encode(image_bytes).decode('utf-8')
        
        result = disease_detector.analyze(image_bytes, image_base64)
        return result
    except Exception as e:
...
def get_market_insights(
    ...
    # ✅ SORT BY DATE (Ascending) for correct graph trends
    if "Arrival_Date" in sub.columns:
        sub = sub.sort_values(by="Arrival_Date", ascending=True)
